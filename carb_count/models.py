...
class Product(models.Model):
    ...
    fats = models.DecimalField(max_digits=5, decimal_places=1, null=False, verbose_name='Fats (g per 100g)')
    proteins = models.DecimalField(max_digits=5, decimal_places=1, null=False, verbose_name='Proteins (g per 100g)')
